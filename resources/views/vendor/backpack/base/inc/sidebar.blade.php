    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="{{ url(config('backpack.base.route_prefix', 'admin') . '/productos') }}"><i class="fa fa-shopping-bag"></i> <span>Productos</span></a></li>
          <li><a href="{{ url(config('backpack.base.route_prefix', 'admin') . '/categorias') }}"><i class="fa fa-list"></i> <span>Categorías</span></a></li>
